...
def salvar_categorias_no_sheets(tipo):
    ...
    try:
        ...
        st.error(f"Erro ao salvar no Sheets. Verifique se a aba 'Categorias_{tipo}' existe na sua planilha.")
...
with tab_desp:
    ...
    if not df_edit_desp.equals(df_desp_m):
        atualizar_base_geral(df_edit_desp, "Despesa")import streamlit as st
import pandas as pd
import plotly.express as px
import plotly.graph_objects as go
from datetime import date
